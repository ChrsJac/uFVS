...
fixed_rows <- data.frame(
  Component = c("uFVS-authored source", "USDA Forest Vegetation Simulator",
                "FVS NVEL volume submodule", "FVS Interface rFVS/fvsOL", "R runtime"),
  Type = c("Original", "FVS", "Other third-party source", "FVS Interface", "R"),
  ...
  License = c("MIT", "See THIRD_PARTY/FVS/license.txt",
              "No license file identified; human review required", "MIT", "GPL-2 | GPL-3"),
  ...
  `Copyright/Authors` = c("J. Christopher Jacobson", "United States Federal Government materials",
                          "See THIRD_PARTY/FVS/NVEL-source-reference.txt", "USDA Forest Service", "R Core Team"),
  `License files` = c("LICENSE", "FVS/license.txt", "FVS/NVEL-source-reference.txt",
                      "FVS-Interface/source-reference.txt", "runtime/R/COPYING and runtime license files"),

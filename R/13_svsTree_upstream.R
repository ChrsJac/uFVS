# ------------------------------------------------------------------------------
# SVS 3D tree rendering - vendored from the official FVS interface.
#
# This file is fvsOL/R/svsTree.R from the USDA Forest Service
# ForestVegetationSimulator-Interface repository (MIT licensed), reproduced here
# so uFVS draws SVS trees exactly the way the official interface does.
#
#   Source:   https://github.com/USDAForestService/ForestVegetationSimulator-Interface
#   Snapshot: commit 7b608f8265770e70065c5d03fe4cd061699fe479
#
# It is upstream code. Do not edit it to change how uFVS looks; wrap it instead.
# uFVS additions live in R/12_svs.R. See NOTICE.md.
#
# Requires the rgl package. uFVS treats 3D as optional and falls back to its own
# 2D views when rgl is unavailable.
# ------------------------------------------------------------------------------
